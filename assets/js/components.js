document.addEventListener("DOMContentLoaded", function () {
    ...
    // --- 2. IMPLEMENTAÇÃO DO HEADER DO GERAL DO SITE---
    ...
    if (headerElementeGeneral) {
        ...
        <nav class="navbar navbar-expand-lg fixed-top border-bottom bg-white py-2 shadow-sm" style="height: 80px;">
            <div class="container bg-white">
                ...
                <div id="navbarNav" class="collapse navbar-collapse justify-content-end">
                    <ul class="navbar-nav text-center fw-semibold align-items-center">
                        <li class="nav-item"><a class="nav-link px-3" href="/focus"><i class="bi bi-house-door fs-6"></i> HOME</a></li>
                        <li class="nav-item"><a class="nav-link px-3" href="/focus/servicos/todos-servicos.html">SERVIÇOS</a></li>
                        <li class="nav-item"><a class="nav-link px-3" href="/focus/focus/empresa.html">EMPRESA</a></li>
                        <li class="nav-item"><a class="nav-link px-3" href="/focus/focus/trabalhe-conosco.html">TRABALHE CONOSCO</a></li>
                        <li class="nav-item"><a class="nav-link px-3" href="/focus/focus/contato.html">CONTATO</a></li>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="contact-box p-4 p-md-5 rounded-4 shadow-sm border">
                        ...
                        <a href="https://wa.me/555181823676" target="_blank" class="social-icon">
                            <svg class="header_svg_wpp" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                        ...
                        <a href="http://t.me/focus_service" target="_blank"  class="social-icon">
                            <svg class="header_svg_telegram" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telegram" viewBox="0 0 16 16">
    ...
    // --- 4. IMPLEMENTAÇÃO DO FOOTER GERAL DO SITE ---
    const footerElementGeneral = document.querySelector("#footer-general-placeholder");
    if (footerElementGeneral) {
        footerElementGeneral.innerHTML = `
        <footer class="bg-black text-light pt-5 pb-3">
            <div class="container-xl">
